...
private:
    ...
    int getIdx(string, string*, int);
    int smallest(std::vector<int>, std::vector<bool>);
    bool findCycle(string *keys,std::vector<bool> &,std::vector<bool>&, string);
    int isVisited(std::vector<bool>);
};
// End of header file
